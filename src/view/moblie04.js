...
const Moblie04 = () => {
  ...
  return (
    ...
    <section
      ref={wrapperRef}
      className="relative  left-1/2 -translate-x-1/2 text-white w-full h-[100vh] z-40 "
      style={{
        perspective: "800px",
      ...
      >
        ...
        <div className="space-y-10 mt-20">
          {[
            ...
            >
              <div className="col-span-7 text-[26px]">{title}</div>
              ...
              <div className="col-span-2 text-[20px] text-right">{date}</div>
            </div>
          ))}
        </div>
      </div>
