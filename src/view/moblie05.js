...
const Moblie05 = () => {
  return (
    <>
    <section id='view05' className='relative w-full h-[100vh] text-white px-3'>
    <div className='w-full h-[150px] text-center text-2xl text-white'>
        <div className='text-white opacity-50 text-[30px] -translate-x-10'>LET'S GET DOWN</div>
        <div className='flex items-center gap-2 translate-x-40'>
            <h2 className='text-white leading-none text-[30px] '>TO BUSINESS</h2>
    ...
    <div className="mb-2 text-[30px] flex items-center gap-2">
        <span>HELLO@COSMOS.STUDIO</span>
        <span className="border border-white w-[14px] h-[14px] inline-block"></span>
      </div>
      <div
