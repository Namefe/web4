  ...
  return (
    ...
    <div className='w-full h-[200px] flex flex-col items-center justify-start text-2xl text-white'>
        ...
        <div className='flex items-center gap-2 translate-x-10'>
            <h2 className='text-white leading-none text-[34px] md:text-[48px]'><span className='font-gridular'>T</span>O BU<span className='font-gridular'>S</span>INE<span className='font-gridular'>SS</span></h2>
